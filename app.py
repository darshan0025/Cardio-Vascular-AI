...
# Monkeypatch for _RemainderColsList
if not hasattr(sklearn.compose._column_transformer, '_RemainderColsList'):
    class _RemainderColsList(list):
        """Mock class for backward/forward compatibility"""
        pass
...
<style>
    ...
    .stMarkdown, .stText, p, label, .stSelectbox label, .stNumberInput label, .stAlert, h1, h2, h3, h4, h5, h6 {
